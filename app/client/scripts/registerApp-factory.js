angular.module('registerApp')
    .factory('registerAppFactory', registerAppFactory);

registerAppFactory.$inject = ['Restangular', '$location', '$window', '$localStorage', 'mainFactory'];

function registerAppFactory(Restangular, $location, $window, $localStorage, mainFactory) {
    'use strict';
